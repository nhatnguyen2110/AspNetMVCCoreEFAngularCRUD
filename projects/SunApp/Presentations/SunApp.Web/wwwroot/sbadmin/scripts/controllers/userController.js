...
app.controller('UserCtrl', function ($scope, $state, $compile, $log, $uibModal, DTOptionsBuilder, DTColumnBuilder, UserService, Notification, ModalService) {
    $scope.dtInstance = {};
    ...
    $scope.$on('reload-users', function (event, msgObj) {
        if (msgObj = 'reload user grid') {
            $scope.reloadUsers();
        }
    });
