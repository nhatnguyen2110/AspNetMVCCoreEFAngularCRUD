angular.module('MyApp').factory('User', function ($q, $http) {
    var userService = {};
    userService.users = [];
    userService.currentUser = {};
    userService.userFillToModal = {};
    userService.passwordtypes = [];
    userService.passwordChangeObj = {};
    userService.passwordChangeResult = {};
    ...
    userService.newUser = function () {
        ...
        $http.get("api/user/new")
            .then(function successCallback(response) {
                ...
                // when the response is available
                deferred.resolve(
                    userService.userFillToModal = response.data);
    ...
    userService.newPasswordChange = function (userId) {
        ...
        $http.get("api/user/changepassword/new/" + userId)
            .then(function successCallback(response) {
                ...
                // when the response is available
                deferred.resolve(
                    userService.passwordChangeObj = response.data
                );
    ...
    userService.savePasswordChange = function (passwordChange) {
        ...
        $http({
            ...
            .then(function successCallback(response) {
                ...
                // when the response is available
                deferred.resolve(
                    userService.passwordChangeResult = response.data);
