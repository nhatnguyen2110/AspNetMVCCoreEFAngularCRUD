...
namespace SunApp.Data
{
    ...
    public partial interface IDbContext
    {
        ...
        DbSet<TEntity> Set<TEntity>() where TEntity : BasicEntity;
        ...
        /// <param name="parameters">The values to be assigned to parameters</param>
        /// <returns>An IQueryable representing the raw SQL query</returns>
        IQueryable<TEntity> EntityFromSql<TEntity>(string sql, params object[] parameters) where TEntity : BasicEntity;
        ...
        void Detach<TEntity>(TEntity entity) where TEntity : BasicEntity;
