...
using SunApp.Core;
using SunApp.Data.Mapping;

namespace SunApp.Data
{
    public class SunAppObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public SunAppObjectContext(DbContextOptions<SunAppObjectContext> options) : base(options)
        {
        ...
        public virtual new DbSet<TEntity> Set<TEntity>() where TEntity : BasicEntity
        {
        ...
        /// <param name="parameters">The values to be assigned to parameters</param>
        /// <returns>An IQueryable representing the raw SQL query</returns>
        public virtual IQueryable<TEntity> EntityFromSql<TEntity>(string sql, params object[] parameters) where TEntity : BasicEntity
        {
        ...
        public virtual void Detach<TEntity>(TEntity entity) where TEntity : BasicEntity
        {
            if (entity == null)
